...
class _MovieDetailRestApi implements MovieDetailRestApi {
  ...
  @override
  Future<VideoMovieResponse> getVideoMovie(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<VideoMovieResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = VideoMovieResponse.fromJson(_result.data!);
    return value;
  }
